...
- 2026-09-17: noise and hearing, phases A to D of `docs/design/noise.md`, the second sense `docs/design/stealth.md` deferred.
  ...
  Deferred: phase E, `Row::heard` on the nearby rail and the heist's log of what the thief hears.

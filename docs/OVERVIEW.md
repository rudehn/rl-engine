...
- Panels: `NearbyPanel`, `VitalsPanel`, `GearPanel`, `InspectPanel`, `LogPanel`, `ScrollbackPanel`, `TargetPanel`, `AbilityPanel` and `ControlsPanel`, each a plugin holding its rectangle and its headings.

...
Last updated: 2026-09-14, after one registries resource and names for a game's own content.
...
- Combat: health, armor, resists, factions as `CombatRules`, the matrix over the registry's sides, melee and ranged attacks down a line of fire, extra strikes, the damage event pipeline, and deaths that linger until the frame ends. It knows nothing of minds or abilities: a blow is a blow whoever chose it.

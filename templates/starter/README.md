...
- **Combat.** Walk into a goblin to strike it; armor takes its share of every blow.
...
The [guide](https://github.com/rudehn/rl-engine/tree/main/docs/guide/src) builds a roguelike one chapter at a time, and each chapter is something to add here:
